...
{
    public class UpdateLiquorValidator : AbstractValidator<LiquorDto>
    {
        public UpdateLiquorValidator(LiquorStoreContext context)
        {
            RuleFor(l => l.Name).NotEmpty().Must((dto, name) => !context.Liquors.Any(l => l.Name == name && l.Id != dto.Id))
